...
const argsInfo = {
  ...
  CreateManyAndReturnCategoryArgs: ["data"],
...
const outputsInfo = {
  ...
  CategoryGroupBy: ["id", "name", "slug", "_count", "_min", "_max"],
  ...
  CategoryCountAggregate: ["id", "name", "slug", "_all"],
  CategoryMinAggregate: ["id", "name", "slug"],
  CategoryMaxAggregate: ["id", "name", "slug"],
  CreateManyAndReturnUser: ["id", "email", "name"],
  UpdateManyUserAndReturnOutputType: ["id", "email", "name"],
  CreateManyAndReturnPost: ["id", "createdAt", "updatedAt", "published", "title", "content", "authorId", "author"],
  UpdateManyPostAndReturnOutputType: ["id", "createdAt", "updatedAt", "published", "title", "content", "authorId", "author"],
  CreateManyAndReturnCategory: ["id", "name", "slug"],
  UpdateManyCategoryAndReturnOutputType: ["id", "name", "slug"]
};
...
const inputsInfo = {
  ...
  CategoryWhereInput: ["AND", "OR", "NOT", "id", "name", "slug"],
  CategoryOrderByWithRelationInput: ["id", "name", "slug"],
  CategoryWhereUniqueInput: ["id", "slug", "AND", "OR", "NOT", "name"],
  CategoryOrderByWithAggregationInput: ["id", "name", "slug", "_count", "_max", "_min"],
  CategoryScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "slug"],
  ...
  CategoryCreateInput: ["id", "name", "slug"],
  CategoryUpdateInput: ["id", "name", "slug"],
  CategoryCreateManyInput: ["id", "name", "slug"],
  CategoryUpdateManyMutationInput: ["id", "name", "slug"],
  ...
  CategoryCountOrderByAggregateInput: ["id", "name", "slug"],
  CategoryMaxOrderByAggregateInput: ["id", "name", "slug"],
  CategoryMinOrderByAggregateInput: ["id", "name", "slug"],

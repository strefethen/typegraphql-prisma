...
export class CreateManyAndReturnCategoryResolver {
  ...
  async createManyAndReturnCategory(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: CreateManyAndReturnCategoryArgs): Promise<CreateManyAndReturnCategory[]> {
